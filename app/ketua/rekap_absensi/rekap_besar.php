...
<div class="content">
    ...
    <div class="content-top">
        ...
        <div class="select">
            ...
            <div class="select-content" id="absensiContent">
                ...
                <div class="select-option" data-value="rekap_besar.php" onclick="selectAbsensi(this)" selected>Absensi Hari Besar</div>
            </div>
        </div>
    </div>
    ...
    <div class="periode" style="display: none;">
        ...
        <?php 
            ...
            $selectedKegiatan = isset($_GET['kegiatan']) ? (int)$_GET['kegiatan'] : 2;
            ...
            $studentsQuery = mysqli_query($conn, 
                "SELECT DISTINCT warga.nim, warga.nama, warga.prodi, status_kehadiran
                 FROM warga 
                 JOIN absensi ON absensi.nim = warga.nim
                 WHERE absensi.id_kegiatan = $selectedKegiatan"
            );
