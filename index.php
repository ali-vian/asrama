...
<body id="top" class="dark_theme">
  ...
  <main>
    ...
    <div class="skills-content section-content">
      ...
      <section class="contact" id="aspirasi">
        ...
        <form onsubmit="sendToWhatsApp(event)" class="contact-form">
            ...
            <div class="form-wrapper">
              ...
              <div class="input-wrapper">
                <input type="email" name="email" id="email" required placeholder="student@student.trunojoyo.ac.id" class="input-field">
            ...
            <div class="form-wrapper">
              ...
              <div class="input-wrapper">
                <textarea name="message" id="message" required placeholder="Aspirasi..." class="input-field"></textarea>
  ...
  <!-- 
    - custom js link
  -->
  <script src="./assets/js/scriptlandingpage.js"></script>
  ...
  <script>
        ...
        function sendToWhatsApp(event) {
          ...
          const whatsappNumber = "6285226190457";
