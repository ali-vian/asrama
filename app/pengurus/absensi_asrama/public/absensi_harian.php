...
// Query dengan kondisi LIKE pada semua kolom yang diinginkan jika ada pencarian
      ...
      <div class="flex-1 ml-64 p-6 overflow-scroll h-screen">
        ...
        <div class="pdf_magrib bg-white p-6 rounded-lg shadow-lg mb-10">
          <div class="flex items-center justify-between mb-4">
            <h3 class="text-xl font-semibold text-gray-800">Jamaah Wajib</h3>
            <a href="tambah.php" class="px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600">Tambah</a>
